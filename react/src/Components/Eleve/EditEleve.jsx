...
const result = await axios.get(`http://127.0.0.1:8000/api/eleves/${id}`);
const { data } = result;
...
setUser_id(data.user_id);
  ...
  const handleSubmit = async (event) => {
    ...
    try {
     const eleve= await axios.put(`http://127.0.0.1:8000/api/eleves/${id}`, newEleve);
